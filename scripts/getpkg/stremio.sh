...
wget -q --show-pwget -q --show-progress "$(wget -qO- https://www.stremio.com/downloads|grep amd64.deb|cut -d '"' -f248)"
rogress "$(wget -qO- https://www.stremio.com/downloads|grep amd64.deb|cut -d '"' -f286)"