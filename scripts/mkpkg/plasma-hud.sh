...
#PLASMA_HUD_TAG="$(wget -qO- --header="X-Auth-Token: $GITHUB_TOKEN" https://api.github.com/repos/Zren/plasma-hud/releases|grep tag|head -n1|cut -d '"' -f4|sed 's@https://github.com/Zren/plasma-hud/releases/tag/@@g')"
